      ...
      <div className="flex flex-1 flex-col gap-6 overflow-y-auto bg-[#EEE6E6] px-8 py-16">
        <div className="flex lg:flex-row flex-col gap-4">
          <div className="flex flex-col gap-4 flex-1">
            ...
            <label htmlFor="email" className="text-xl font-extrabold">Your Email</label>
            <input
              type="email"
              id="email"
            ...
            <label htmlFor="password" className="text-xl font-extrabold">Your Password</label>
            <input
              type="password"
              id="password"
              placeholder="●●●●●●●●"
        ...
        <div className="border-[3px] rounded-xl shadow-lg shadow-gray-300 border-gray-400 bg-white p-4 gap-4 flex flex-col">
          ...
          <div className="flex flex-row gap-4">
            <img src={colorPalette} className="rounded-full h-12 w-12" alt="Color Palette" />
            <div className="flex flex-col gap-1">
