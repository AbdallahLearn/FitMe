  ...
  return (
    <div className="flex flex-col items-center justify-center h-full" >
     ...
     Please Wait To Generate Your Model
      ...
      <div className="text-7xl font-bold text-[#EE8B48]  w-60 h-60 flex justify-center items-center rounded-full" style={{border:'1px solid rgba(0,0,0,0.3)'}}><h1>{count}</h1></div> {/* Display the count */}
      {count === 0 && (
        <div className="mt-4">
