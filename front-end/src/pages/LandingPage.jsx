...
// import circle from '../assets/circleWords.png'
      ...
      <div className="flex-grow flex flex-col justify-center items-center gap-5">
        <motion.div className="relative w-full bg-[#1D1B1B] text-white text-center pb-20 max-sm:pb-3">
          ...
          <div className="flex justify-center items-center gap-56 md:gap-20">
            <p className="flex items-center xl:text-[22rem] lg:text-[17rem] md:text-[15rem] title-font lg:gap-60 md:gap-20 max-md:text-[13rem] font-bold max-sm:text-[6rem] max-sm:gap-20">
              F{text}
              <span
                className="text-black outline-white  title-font font-bold  pl-4"
          ...
          <div className="flex justify-between items-center lg:px-16 -mt-10 max-sm:mt-0">
            ...
            <div className="relative">
              {/* <img src={circle} className="w-36 max-sm:w-20" /> */}
              <img src="/images/CircleWords.png" className="w-36 max-sm:w-20" />
              <img
                src={manImage}
