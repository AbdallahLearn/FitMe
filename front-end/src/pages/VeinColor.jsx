  ...
  return (
    <div className="card-body flex flex-col justify-center items-center w-full max-w-full sm:max-w-[80%] h-auto sm:h-96 mx-auto p-4 box-border">
      ...
      <div className="flex flex-wrap justify-center gap-8">
        <div 
          className={`box rounded-lg text-center cursor-pointer px-8 p-2 flex flex-col items-center ${selected === 'warm' ? 'border-4 border-green-500' : 'border border-gray-400'}`}
          onClick={() => handleSelect('warm')}
        >
          <h1 className="text-base sm:text-lg font-extrabold">WARM</h1>
        ...
        <div 
          className={`box rounded-lg text-center cursor-pointer px-8 p-2 flex flex-col items-center ${selected === 'cool' ? 'border-4 border-blue-500' : 'border border-gray-400'}`}
          onClick={() => handleSelect('cool')}
        >
          <h1 className="text-base sm:text-lg font-extrabold">COOL</h1>
        ...
        <div 
          className={`box rounded-lg text-center cursor-pointer px-8 p-2 flex flex-col items-center ${selected === 'neutral' ? 'border-4 border-gray-500' : 'border border-gray-400'}`}
          onClick={() => handleSelect('neutral')}
        >
          <h1 className="text-base sm:text-lg font-extrabold">NEUTRAL</h1>
